...
1. **Kopf** (kompakt seit 013) – eine Zeile mit Avatar-Kürzel, zwei Navigations-Icons (Haus = Aufgaben, Münze = Finanzen; aktiv gefüllt, Inline-SVG) und der Statuszeile; darunter der Countdown in einer Zeile („115 Tage bis zur Schlüsselübergabe · 15.01.2027", Zahl 28 px, das Datum öffnet das Datumsfeld) und die fünfteilige **Gate-Leiste** auf halber Höhe: Nummer und Füllbalken, der Zähler steckt im Tooltip.
