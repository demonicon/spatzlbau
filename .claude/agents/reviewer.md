---
name: reviewer
description: Prueft den Diff eines Auftrags gegen dessen Akzeptanzkriterien und die Design-/DB-Regeln, ohne selbst etwas zu aendern. Vom Skill /auftrag in Schritt 7 aufgerufen.
model: opus
...
(e) Nur bei `Art: Feature` (fehlt das Kopf-Feld `Art`, gilt `Feature`): Abschnitt „Klärung" vorhanden, mindestens drei beantwortete Fragen, und jede genannte Konsequenz findet sich in Änderungen oder Tests wieder – sonst Lücke.
